        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/kanal-surat/{{ $kanal->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <input type="text"
                            ...
                            name="judul_surat" id="judul_surat" value="{{ old('judul_surat', $kanal) }}">
                        ...
                        <input type="text"
                            ...
                            name="dari" id="dari" value="{{ old('dari', $kanal) }}">
                        ...
                        <input type="text"
                            ...
                            name="kepada" id="kepada" value="{{ old('kepada', $kanal) }}">
                        ...
                        <input type="text"
                            ...
                            name="tembusan" id="tembusan" value="{{ old('tembusan', $kanal) }}">
                        ...
                        <textarea
                            ...
                            name="isi_ringkasan" id="isi_ringkasan" cols="30" rows="5">{{ old('isi_ringkasan', $kanal) }}</textarea>
