                ...
                <div class="card-body">
                    ...
                    <form action="/kanal-pengaduan/{{ $kanal->id }}" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text"
                            ...
                            name="judul" id="judul" value="{{ old('judul', $kanal) }}">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" id="deskripsi" cols="20"
                            rows="5">{{ old('deskripsi', $kanal) }}</textarea>
                        ...
                        <textarea class="form-control @error('keadaan_terjadi') is-invalid @enderror" name="keadaan_terjadi"
                            id="keadaan_terjadi" cols="20" rows="5">{{ old('keadaan_terjadi', $kanal) }}</textarea>
                        ...
                        <textarea class="form-control @error('keadaan_harapan') is-invalid @enderror" name="keadaan_harapan"
                            id="keadaan_harapan" cols="20" rows="5">{{ old('keadaan_harapan', $kanal) }}</textarea>
