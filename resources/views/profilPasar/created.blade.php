        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/profil-pasar" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <input type="text"
                            ...
                            name="status_pengelola" id="status_pengelola" value="{{ old('status_pengelola') }}">
                        ...
                        <input type="number"
                            ...
                            name="no_perdes" id="no_perdes" value="{{ old('no_perdes') }}">
                        ...
                        <input type="number"
                            ...
                            name="no_sk" id="no_sk" value="{{ old('no_sk') }}">
                        ...
                        <input type="number"
                            ...
                            name="kepemilikan_tanah" id="kepemilikan_tanah" value="{{ old('kepemilikan_tanah') }}">
                        ...
                        <input type="number"
                            ...
                            name="kondisi_bangunan" id="kondisi_bangunan" value="{{ old('kondisi_bangunan') }}">
                        ...
                        <input type="number"
                            ...
                            name="luas_bangunan" id="luas_bangunan" value="{{ old('luas_bangunan') }}">
                        ...
                        <div class="btn-group" role="group" aria-label="Small radio toggle button group">
                            ...
                            <input type="radio" class="btn-check @error('kantor_pasar') is-invalid @enderror"
                                ...
                                {{ old('kantor_pasar') == 'tidak' ? 'checked' : '' }}>
                        ...
                        <input type="number"
                            ...
                            name="jml_kios" id="jml_kios" value="{{ old('jml_kios') }}">
                        ...
                        <input type="number"
                            ...
                            name="jml_los" id="jml_los" value="{{ old('jml_los') }}">
                        ...
                        <input type="number"
                            ...
                            name="jml_toilet" id="jml_toilet" value="{{ old('jml_toilet') }}">
                        ...
                        <input type="number"
                            ...
                            name="jml_pedagang" id="jml_pedagang" value="{{ old('jml_pedagang') }}">
                        ...
                        <input type="number"
                            ...
                            name="sumber_pembiayaan" id="sumber_pembiayaan" value="{{ old('sumber_pembiayaan') }}">
                        ...
                        <input type="number"
                            ...
                            value="{{ old('hasi_retibusi_tahunan') }}">
                        ...
                        <input type="number"
                            ...
                            name="kontribusi_pades" id="kontribusi_pades" value="{{ old('kontribusi_pades') }}">
                        ...
                        <input type="text"
                            ...
                            name="kendala" id="kendala" value="{{ old('kendala') }}">
